...
A full-stack web application where users can browse courses and subscribe to free or paid courses using a mock promo code system.
...
- Free and paid course subscription logic
- Promo code support (BFSALE25 → 50% discount)
- My Courses page to view subscribed courses
- Protected routes
